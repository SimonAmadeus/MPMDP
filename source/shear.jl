...
function apply_shear(args::System, particle_vec::Vector{Particle}, velocity_vec::Vector{Velocity}, shear::Shear_CTRL)
    ...
    if isempty(i_list_0) == false && isempty(i_list_M) == false
        ...
        args.j += velocity_vec[i_list_0[i_0]].velocity[1] * particle_vec[i_list_0[i_0]].mass
        args.j += velocity_vec[i_list_M[i_M]].velocity[1] * particle_vec[i_list_M[i_M]].mass
...
function sample_velocity_profile(file0, file1, step::Int64, args::System, particle_vec::Vector{Particle}, velocity_vec::Vector{Velocity}, shear::Shear_CTRL)    
    ...
    args.j = args.j /(2 * step * args.box[1] * args.box[2])
