...
function sys_init()
    ...
    return System(system_type, shear, shear_sample_freq, j, t_bonds, bonded_interactions, non_bonded_interactions, angle_interactions, nl, sum, thermostat, barostat, init_velocity, ∆t, T, p, κ, box, n_steps, traj_freq, log_freq, data_file, traj_file, log_file, shear_file, momentum_file, restart_file, trajectorydump, logger, restart, first_step)
end
