    ...
    for kcell = 0:mesh.N[3] - 1
        for jcell = 0:mesh.N[2] - 1
            for icell = 0:mesh.N[1] - 1
                ...
                grad_x = 0.5 * (mesh.particle_grid[icell_plus, jcell_, kcell_] - mesh.particle_grid[icell_minus, jcell_, kcell_])
                grad_y = 0.5 * (mesh.particle_grid[icell_, jcell_plus, kcell_] - mesh.particle_grid[icell_, jcell_minus, kcell_])
                grad_z = 0.5 * (mesh.particle_grid[icell_, jcell_, kcell_plus] - mesh.particle_grid[icell_, jcell_, kcell_minus])
