...
function apply_non_bonded_interactions!(args::System, ::System_Type, particle_vec::Vector{Particle}, c_l::Int64, force_vec::Vector{Force}, energy::Float64, stress::Vector{Float64}, mesh::Mesh, hPF::Non_Bonded_Interactions)

    clear_mesh!(mesh)
    for i = 1:length(particle_vec)
        cloudincell!(particle_vec[i].pos, mesh)
    end
